...
export class TsTableComponent implements OnInit {
  ...
  export() {
    this.exportService.exportExcel(this.excel_, 'Soil_temperature');
  }
     ...
     if(e.mesure == "soil_temperature"){
         ...
         e.data.map(a => {
           ...
           a.value.map(b => {  
            ...
            this.valueTime.push(
             {id_exploitation: e.id_exploitation,mesure :  '<i class="fas fa-thermometer"></i>',
